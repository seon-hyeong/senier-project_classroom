      ...
      <div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 portfolio-info">
					...
					<ul>
						<h3>
							<li><strong>과제 내용</strong>:</br> ${detail.assignDes}</li>
						</h3>
						</br>
						...
						<c:if test="${isMaster == '1'}">
							<div class="form-group">
								<form name="fileForm" action="/assign/upload" method="post" enctype="multipart/form-data">
									<c:if test="${assignFile == null}">
									<label for="exampleInputFile">과제 올리기</label> 
									<input multiple="multiple" type="file" class="form-control-file" name="uploadFile" id="uploadFile" aria-describedby="fileHelp"> 
									<label for="assignName" class="sr-only">과제 이름</label>
										<input type="text" id="assignName" name="assignName"
											class="form-control" placeholder="assignName" required
											autofocus>
									<label for="userId" class="sr-only">학생 ID</label>
